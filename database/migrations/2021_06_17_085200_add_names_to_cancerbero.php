...
class AddNamesToCancerbero extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared("ALTER TABLE `modules` CHANGE COLUMN `name` `name` VARCHAR(191) NULL DEFAULT NULL COLLATE 'utf8_unicode_ci' AFTER `id`");
        DB::unprepared("ALTER TABLE `permissions` CHANGE COLUMN `name` `name` VARCHAR(191) NULL DEFAULT NULL COLLATE 'utf8_unicode_ci' AFTER `id`");
