...
class CsgtModule
{
    ...
    public function __construct($aName, $aDescription, $aModule, $aMenuOrder, $aIcon = null, $aParentModule = null, $aPermissions = self::ALL, $aMenuPermission = 'index', $aExternalId = null)
    {
        $this->name           = $aName;
